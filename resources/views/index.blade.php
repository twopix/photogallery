    ...
    <div class="page page_bg-full-scr">
        <main class="main">
            <div class="main__wrap main__wrap_middle welcome">
                ...
                <div class="welcome__text">Перед вами сервис, который поможет вам организовать свои фотографии <br />в альбомы и поделиться ими со всем миром! <Br>
                    test login: ryanchenkie@gmail.com
                    pass: secret
